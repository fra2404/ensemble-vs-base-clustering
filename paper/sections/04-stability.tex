...
& HGPA & \textbf{0.770} & \textbf{0.566} & \textbf{0.838} & \textbf{0.498} \\
...
\caption{Bootstrap stability analysis for Mall Customers dataset (ARI and VI distributions)}
...
\caption{Noise injection stability comparison for Mall Customers dataset ($\sigma$ = 0.05)}
